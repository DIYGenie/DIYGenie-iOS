...
extension Project {
    ...
    func updating(name: String? = nil,
                  ...
                  scanJson: [String: AnyCodable]? = nil,
                  arProvider: String? = nil) -> Project {
        Project(
            id: id,
            userId: userId,
            name: name ?? self.name,
            ...
            budgetTier: budgetTier,
            skillLevel: skillLevel ?? self.skillLevel,
            status: status ?? self.status,
            createdAt: createdAt,
            updatedAt: updatedAt ?? self.updatedAt,
            preview_url: previewURL ?? self.preview_url,
            input_image_url: inputImageURL ?? self.input_image_url,
            arProvider: arProvider ?? self.arProvider,
            arConfidence: arConfidence,
            scalePxPerIn: scalePxPerIn,
            calibrationMethod: calibrationMethod,
            referenceObject: referenceObject,
            roomType: roomType,
            scanJson: scanJson ?? self.scanJson,
            dimensionsJson: dimensionsJson,
            floorplanSvg: floorplanSvg,
            deviceModel: deviceModel,
            osVersion: osVersion,
