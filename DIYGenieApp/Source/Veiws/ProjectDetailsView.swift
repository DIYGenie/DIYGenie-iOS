...
/// provides a button to open the full build plan, and displays a summary of the
/// plan once it has been generated by the backend.  It gracefully handles
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                // Display summary sections if the plan is loaded
                if let plan = plan {
